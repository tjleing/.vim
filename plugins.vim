...
"Plug 'kana/vim-textobject-user'  " create text objects, used by next plug
Plug 'reedes/vim-textobj-quote'  " extend vim to better use curly quotes
...
"Plug 'Valloric/YouCompleteMe' " complete all the thingsssss
Plug 'majutsushi/tagbar' " put tags on the side in a bar
